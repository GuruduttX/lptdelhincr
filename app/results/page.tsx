...
export default function Results() {
  return (
    <ContentPage
      ...
      intro={
        <>
          {BRAND} has earned <strong>140+ IIM selections in 2 years</strong>,
          including <strong>AIR 9, 22 and 24 at IIM Indore</strong> and 80+ IIM
          seats in 2025 alone. Every entry below names the student, exam and
          institute — we publish only verified, attributable selections, never
      ...
      schema={[
        articleSchema({
          headline: "LPT Delhi-NCR — CUET & IPMAT Results",
    ...
    >
      ...
      <Section id="selections" heading="Selections & calls by institute">
        <p>
          A snapshot of named IPMAT and JIPMAT selections and interview calls
          from recent cycles — with many more across both years.
        </p>
                ...
                {group.students.map((s, i) => (
                  ...
                  >
                    ...
                    <span className="text-body">
                      {" "}
                      — {s.percentile ? s.percentile : s.status}
                    </span>
                  </li>
                ))}
              </ul>
      ...
      <Section id="cuet" heading="CUET 2025 toppers">
        <p>
          Verified CUET 2025 percentiles from our students — named, with subject
          and school.
        </p>
          ...
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <figcaption className="mt-3 text-sm font-bold text-ink">
                {t.name}{" "}
                <span className="font-medium text-body">· {t.institute}</span>
              </figcaption>
            </figure>
          ))}
        </div>
