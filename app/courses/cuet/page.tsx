...
const faqs: FAQItem[] = [
  {
    ...
    a: (
      <>
        Yes. CUET (UG) coaching is available in offline, online and hybrid modes
        across our 4 Delhi-NCR centres in Noida, Hauz Khas, GTB Nagar and
        Gurugram. Book a free demo to find the batch that fits your schedule.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        CUET (UG) offline fees at our GTB Nagar (Delhi) centre start from
        ₹25,000 (CUET 2026 Crash Course) and go up to ₹90,000 for the 2-year
        CUET 2028 batch — all excluding GST. See the batch table above for each
        option.
      </>
    ),
  },
...
export const metadata: Metadata = pageHead({
  ...
  description:
    "CUET (UG) coaching in Delhi-NCR — domain, general & language tracks. Offline, online & hybrid batches across 4 centres. Book a free demo.",
  path: "/courses/cuet",
});

export default function CuetCourses() {
  return (
    <ContentPage
      ...
      intro={
        <>
          {BRAND} offers CUET (UG) coaching covering domain subjects, the
          general test and languages, across 4 Delhi-NCR centres. Offline
          batches at GTB Nagar (Delhi) start from ₹25,000 (excl. GST); see the
          full batch lineup and fees below.
        </>
      }
      toc={[
      ...
      schema={[
        courseSchema({
          ...
          description:
            "CUET (UG) coaching covering domain, general and language tracks, in offline, online and hybrid modes.",
          courseMode: "Offline",
    ...
    >
      ...
      <Section id="online" heading="Online & self-paced batches">
        <p>
          Prefer to study from home? Choose a live, hybrid or recorded CUET
          batch — fees confirmed on a free counselling call.
        </p>
        <ComparisonTable
          ...
          rows={CUET_ONLINE_BATCHES.map((b) => ({
            ...
            duration: b.duration,
            discount: (
              <span className="font-semibold text-brand">{b.discount}</span>
            ),
          }))}
        />
      </Section>
      ...
      <Section id="material" heading="Study material & mocks">
        <p>
          Sharpen your prep with our CUET test series and printed study
          material:
        </p>
