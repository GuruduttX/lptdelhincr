...
export const metadata: Metadata = pageHead({
  ...
  description:
    "CUET and IPMAT coaching batches at LPT Delhi-NCR — offline, online and hybrid. See tracks and book a free demo.",
  path: "/courses",
});
...
export default function Courses() {
  ...
  return (
    <HubPage
      ...
      intro={
        <>
          {BRAND} runs CUET (UG) and IPMAT/JIPMAT coaching batches across 4
          Delhi-NCR centres in offline, online and hybrid modes. Choose your
          track below — fees and dates are confirmed during a free counselling
          call.
        </>
      }
      groups={[
        {
          heading: "CUET Coaching",
          icon: "Building2",
          items: cuet?.entries ?? [],
        },
        {
          heading: "IPMAT Coaching",
          icon: "Building2",
          items: ipmat?.entries ?? [],
        },
      ]}
