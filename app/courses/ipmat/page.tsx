...
const faqs: FAQItem[] = [
  {
    ...
    a: (
      <>
        IPMAT coaching is a structured program that prepares students for the
        IPMAT exam through live classes, mock tests, mentorship and study
        material — available offline at our Delhi-NCR centres and online from
        anywhere.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        We prepare students for IPMAT Indore, IPMAT Rohtak and JIPMAT — the
        integrated programme entrance tests — covering Quantitative Aptitude,
        Verbal Ability and (for Rohtak) Logical Reasoning, plus PI/WAT
        preparation.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Online IPMAT fees are ₹12,000 for the 2026 batch, ₹59,999 for the 2027
        Target batch and ₹99,999 for the 2028 Foundation batch (excl. GST). A
        dedicated Personal Interview prep program is ₹699.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        IPMAT offline fees at our GTB Nagar (Delhi) centre are ₹80,000 for the
        1-year Target & Finisher batches and ₹1,40,000 for the 2-year Foundation
        batch (Class 11) — all excluding GST. See the batch table above.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Yes. IPMAT coaching runs in offline, online and hybrid modes across our
        4 Delhi-NCR centres. Book a free demo to choose the batch and mode that
        suit you.
      </>
    ),
  },
...
export const metadata: Metadata = pageHead({
  ...
  description:
    "IPMAT Indore & Rohtak and JIPMAT coaching in Delhi-NCR. Offline, online & hybrid batches, real faculty, mocks & PI/WAT prep. Book a free demo.",
  path: "/courses/ipmat",
});

export default function IpmatCourses() {
  return (
    <ContentPage
      ...
      intro={
        <>
          {BRAND} offers IPMAT (Indore &amp; Rohtak) and JIPMAT coaching
          covering Quantitative Aptitude, Verbal Ability, Logical Reasoning and
          PI/WAT across 4 Delhi-NCR centres. Offline batches at GTB Nagar
          (Delhi) range from ₹80,000 to ₹1,40,000 (excl. GST); see the full
          lineup below.
        </>
      }
      toc={[
      ...
      schema={[
        courseSchema({
          ...
          description:
            "IPMAT and JIPMAT coaching covering QA, Verbal, Logical Reasoning and PI/WAT, in offline, online and hybrid modes.",
          courseMode: "Offline",
    ...
    >
      <Section id="batches" heading="Batches & fees">
          ...
          rows={IPMAT_BATCHES.map((b) => ({
            ...
            fee: (
              <>
                ...
                {b.originalPrice && (
                  <span className="ml-2 text-xs text-body line-through">
                    {b.originalPrice}
                  </span>
                )}
                {b.discount && (
        ...
        />
        <p className="text-sm">
          Transparent fees, no "enquire for price". Fees shown for the GTB Nagar
          (Delhi) centre, excl. GST; other centres and online/hybrid modes may
          vary — confirm on a free counselling call.
        </p>
      </Section>

      <Section id="online" heading="Online IPMAT batches & fees">
        <p>
          Prefer to learn from anywhere? Our online IPMAT batches run live with
          recorded backups, IIM-alumni mentorship and full mocks. Fees below
          exclude GST.
        </p>
        <ComparisonTable
      ...
      <Section id="covered" heading="What's covered">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Quantitative Aptitude — short-answer and MCQ strategy for Indore
            &amp; Rohtak patterns.
          </li>
      ...
      <Section id="legacy" heading="Numbers that define our legacy">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {LEGACY_STATS.map((s) => (
            <div
              key={s.label}
              className="rounded-2xl bg-cream-soft p-5 text-center"
            >
        ...
        <p className="text-sm">
          Figures reflect the LPT group across all verticals and years.
        </p>
      </Section>
