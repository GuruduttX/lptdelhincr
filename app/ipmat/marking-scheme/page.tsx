...
export default function MarkingScheme() {
  return (
    <ContentPage
      ...
      intro={
        <>
          IPMAT uses different marking across its sections. At{" "}
          <strong>IIM Indore</strong>, the Quant Short-Answer section has{" "}
          <strong>no negative marking</strong>, while QA-MCQ and Verbal deduct
          −1 per wrong answer, under a 40-minute sectional lock.{" "}
          <strong>IIM Rohtak</strong> applies −1 across all sections with no
          lock and adds Logical Reasoning. Verify against iimidr.ac.in /
    ...
    >
      ...
      <Section id="indore" heading="Indore marking — where ranks are made">
        <p>
          <strong className="text-ink">
            QA-SA (type-in) has no negative marking
          </strong>{" "}
          — leaving any blank is a guaranteed loss versus a reasoned attempt, so
          attempt all of them. QA-MCQ and Verbal deduct −1, so guess only after
          eliminating at least one option. The 40-minute{" "}
          <a
          ...
          means you cannot bank time between sections — pace per section, not
          overall.
        </p>
      </Section>
      ...
      <Section id="rohtak" heading="Rohtak marking">
        <p>
          <strong className="text-ink">
            Rohtak deducts −1 everywhere and has no sectional lock
          </strong>
          , so you control your own time across QA, VA and LR — which means the
          real risk is over-investing in one section. Sequence strength-first to
          bank a cushion before harder sections.
        </p>
      </Section>
      ...
      <Section id="math" heading="The marking math (strategy core)">
        <p>
          <strong className="text-ink">
            A blind 4-option guess under −1 has an expected value of (0.25×4) +
            (0.75×−1) = +0.25
          </strong>{" "}
          — barely positive and high-variance. Eliminating even one option
          shifts the odds decisively in your favour; that is the entire guessing
          strategy.
        </p>
        <p>
          On no-negative sections (Indore QA-SA), the math is simpler: a blank
          scores zero, a reasoned attempt has only upside — so never leave one
          blank. Build this instinct with{" "}
          <a href="/courses/ipmat" className="text-brand hover:underline">
            IPMAT coaching
          </a>{" "}
          and check your target via{" "}
