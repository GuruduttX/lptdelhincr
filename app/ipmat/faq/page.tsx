...
export default function IpmatFaq() {
  return (
    <ContentPage
      ...
      intro={
        <>
          Honest answers to what aspirants and parents actually ask about IPMAT
          — how hard it is, self-study vs coaching, and managing the pressure of
          a big early decision. For the full, cluster-organised question bank,
          see the{" "}
          <a href="/faq/ipmat" className="text-brand hover:underline">
            IPMAT FAQ hub
          </a>
          .
        </>
    ...
    >
      ...
      <Section id="guides" heading="Deeper guides">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <a
              href="/ipmat/self-study-vs-coaching"
              className="text-brand hover:underline"
            >
              Self-study vs coaching for IPMAT
            </a>
          </li>
          <li>
            <a
              href="/ipmat/parents-guide"
              className="text-brand hover:underline"
            >
              A parent's guide to IPMAT
            </a>
          </li>
          <li>
