...
export default function ExamHub() {
  return (
    <HubPage
      ...
      intro={
        <>
          The three IPMAT-route exams differ in structure. IIM Indore has QA
          Short-Answer, QA-MCQ and Verbal with a 40-minute sectional lock; IIM
          Rohtak adds Logical Reasoning with −1 across all sections and no lock;
          JIPMAT follows its official bulletin. Figures below are from the
      ...
      faqs={ipmatFaqs
        .filter((f) => f.cluster === "exam" || f.cluster === "marking")
        .slice(0, 6)
        .map((f) => ({ q: f.q, a: f.a }))}
      schema={[
        articleSchema({
          headline: "IPMAT Exam Pattern — Indore vs Rohtak vs JIPMAT",
