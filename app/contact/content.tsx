...
export default function Contact() {
  ...
  return (
    <ContentPage
      ...
      intro={
        <>
          Reach {BRAND} for CUET and IPMAT coaching across our 4 Delhi-NCR
          centres. We respond fastest on WhatsApp — or call, email, or visit the
          centre nearest you.
        </>
      }
      toc={[
    ...
    >
      <Section id="reach" heading="Get in touch">
        <div className="flex flex-wrap gap-3">
          <a
            href={whatsappLink(
              `Hi ${BRAND}, I have a question about CUET/IPMAT coaching`,
            )}
            target="_blank"
            rel="nofollow"
        ...
        >
          <input
            ...
            className="rounded-xl border border-hairline px-4 py-3 text-sm outline-none focus:border-brand"
          />
          <input
            required
            name="phone"
          ...
          {sent && (
            <p className="text-xs text-body">
              If WhatsApp didn't open, message us at the number above.
            </p>
          )}
        </form>
      </Section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {CENTRES.map((c) => (
            ...
            >
              ...
              <address className="mt-2 not-italic text-sm leading-relaxed text-body">
                {c.fullAddress}
              </address>
