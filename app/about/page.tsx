...
export default function About() {
  return (
    <ContentPage
      ...
      intro={
        <>
          {BRAND} is a CUET &amp; IPMAT coaching institute operating{" "}
          {CENTRES.length} centres across Delhi-NCR — Noida, Hauz Khas, GTB
          Nagar and Gurugram — offering offline, online and hybrid batches
    ...
    >
      <Section id="story" heading="Our story">
        <p>
          Founded in{" "}
          {isPlaceholder(FOUNDED_YEAR) ? (
            <Tbd label="founding year" />
          ) : (
            FOUNDED_YEAR
          )}
          , {BRAND} focuses exclusively on CUET and IPMAT preparation. Our full
          founding story, milestones and verified track record will be added
          here from confirmed records.
        </p>
      </Section>
      ...
      <Section id="what-we-do" heading="What we do">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            IPMAT (Indore &amp; Rohtak) and JIPMAT coaching for 5-year
            integrated management programmes.
          </li>
          <li>
            Proctored mock test series, in-house study material, and PI/WAT
            preparation.
          </li>
          <li>
            Offline, online and hybrid batches across {CENTRES.length} Delhi-NCR
            centres.
          </li>
        </ul>
      </Section>
