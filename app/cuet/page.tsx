...
export default function CuetHub() {
  return (
    <HubPage
      canonicalPath="/cuet"
      ...
      intro={
        <>
          CUET (UG) is the common entrance test, conducted by the NTA, used for
          undergraduate admission to central and participating universities.
          Your CUET score feeds each university's own admission process (for DU,
          CSAS). Browse every CUET topic below.
        </>
      }
      vertical="CUET"
      keyFacts={[
    ...
    >
      <p>
        <strong className="text-ink">In one line:</strong> NTA conducts CUET and
        releases scores; universities release cutoffs and run admission. Use the
        sections below — cutoffs and the college predictor, CSAS admission,
        syllabus and study plans, exam info, exam-day logistics, and coaching
        near you.
      </p>
    </HubPage>
  );
