...
export default function CuetFaq() {
  return (
    <ContentPage
      ...
      intro={
        <>
          Honest answers to the questions aspirants and parents actually ask
          about CUET — how hard it is, whether coaching is needed, and how it
          differs from board exams. For the full, cluster-organised question
          bank, see the{" "}
    ...
    >
      ...
      <Section id="guides" heading="Deeper guides">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <a href="/cuet/is-cuet-hard" className="text-brand hover:underline">
              Is CUET hard?
            </a>
          </li>
          <li>
            <a
              href="/cuet/without-coaching"
              className="text-brand hover:underline"
            >
              Can you crack CUET without coaching?
            </a>
          </li>
          <li>
            <a
              href="/cuet/parents-guide"
              className="text-brand hover:underline"
            >
              A parent's guide to CUET
            </a>
          </li>
          <li>
            <a href="/cuet/toppers" className="text-brand hover:underline">
              CUET toppers
            </a>{" "}
            · full{" "}
            <a href="/faq/cuet" className="text-brand hover:underline">
